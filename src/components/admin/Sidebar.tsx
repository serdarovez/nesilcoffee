...
export function Sidebar({ userName, userEmail }: { userName: string; userEmail: string }) {
  ...
  return (
    /* `h-svh` + `sticky` rather than plain flex stretch. As a bare flex child
    ...
    <aside className="sticky top-0 flex h-svh w-64 shrink-0 flex-col self-start border-r border-line bg-paper">
